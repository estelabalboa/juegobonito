...
function preload() 
{
  ...
  game.load.spritesheet('dude', 'assets/dude.png', 30, 50);
  game.load.spritesheet('fruit', 'assets/watermelon.png', 25, 25);
  game.load.image('bullet', 'assets/bullet.png');
  game.load.image('enemybullet', 'assets/enemybullet.png');
  game.load.image('ground', 'assets/ground.png');
  game.load.spritesheet('enemy', 'assets/enemy.png', 100,200);
}
